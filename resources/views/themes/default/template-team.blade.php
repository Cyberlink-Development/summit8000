                    ...
                    <div class="grid grid-cols-12 gap-6">
                        <div class="col-span-3">
                            <div class="image-slot rounded-md before:pt-[120%] shadow shadow-primary/20">
                                <img alt="{{ $data->post_title }}" width="300" height="300" class="rounded"
                                    src="{{$data->page_thumbnail ? asset('uploads/medium/' . $data->page_thumbnail) : asset('theme-assets/assets/trip/8000.jpg')}}" style="color: transparent;">
                            </div>
                        </div>
                        <div class="col-span-9">
                            ...
                            <div>
                                <!-- <a href="team.php" class=" text-white bg-brand-400 hover:bg-brand-500 font-medium rounded-xl text-sm px-5 py-2.5 transition shadow-sm"> Back to Team </a> -->
                            </div>
                        </div>
                    </div>
                </div>
