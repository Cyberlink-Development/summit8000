        ...
        <div class="panel-body" id="row_body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-md-2"> <label>Meals</label></div>
                    ...
                    <div class="row" id="rec-{{ $loop->iteration }}">
                        ...
                        <div class="col-lg-12">
                            <div class="col-md-1"> <input type="number" min="1" max="2000" name="itinerary_ordering[]"
                                    value="{{ $row->ordering }}" class="form-control" placeholder="" /></div>

                            <div class="col-md-1"><input type="text" name="itinerary_days[]" value="{{ $row->days }}"
                                    class="form-control" placeholder="Day" /></div>

                            <div class="col-md-5"><input type="text" name="itinerary_title[]" value="{{ $row->title }}"
                                    class="form-control" placeholder="Title" /></div>

                            <div class="col-md-2"><input type="text" name="itinerary_max_altitude[]"
                                    value="{{ $row->max_altitude }}" class="form-control" placeholder="" /></div>
                            ...
                            <div class="col-md-2"><input type="text" name="itinerary_duration[]" value="{{ $row->duration }}"
